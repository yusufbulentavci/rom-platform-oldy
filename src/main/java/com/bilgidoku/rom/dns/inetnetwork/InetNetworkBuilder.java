 ...
 * under the License.                                           *
 ****************************************************************/
package com.bilgidoku.rom.dns.inetnetwork;

import java.net.UnknownHostException;

import com.bilgidoku.rom.dns.DnsGorevlisi;
import com.bilgidoku.rom.dns.inetnetwork.model.Inet4Network;
import com.bilgidoku.rom.dns.inetnetwork.model.Inet6Network;
import com.bilgidoku.rom.dns.inetnetwork.model.InetNetwork;
...
public class InetNetworkBuilder {
    ...
    private InetNetwork getV4FromString(String netspec) throws UnknownHostException {
        ...
        return new Inet4Network(DnsGorevlisi.tek().getByName(netspec.substring(0, netspec.indexOf('/'))), DnsGorevlisi.tek().getByName(netspec.substring(netspec.indexOf('/') + 1)));
    }
    ...
    private InetNetwork getV6FromString(String netspec) throws UnknownHostException {
        ...
        return new Inet6Network(DnsGorevlisi.tek().getByName(netspec.substring(0, netspec.indexOf('/'))), new Integer(netspec.substring(netspec.indexOf('/') + 1)));
    }
