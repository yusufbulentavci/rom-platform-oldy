 ...
 * under the License.                                           *
 ****************************************************************/
package com.bilgidoku.rom.dns.netmatcher;
...
import com.bilgidoku.rom.dns.inetnetwork.InetNetworkBuilder;
...
public class NetMatcher {
    ...
    public boolean matchInetNetwork(final String hostIP) {
        ...
        try {
            ip = DnsGorevlisi.tek().getByName(hostIP);
    ...
    private void initInetNetworks(final String[] nets) {
        ...
        final InetNetworkBuilder inetNetwork = new InetNetworkBuilder();
