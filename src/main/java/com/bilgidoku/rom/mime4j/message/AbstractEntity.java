...
import com.bilgidoku.rom.mime4j.dom.TextBody;
...
public abstract class AbstractEntity implements Entity {
     ...
     * @see com.bilgidoku.rom.mime4j.message.BodyFactory#textBody(java.io.InputStream, String)
     */
     ...
     *
     * @see com.bilgidoku.rom.mime4j.dom.Disposable#dispose()
     */
    public void dispose() {
        if (body != null) {
            body.dispose();
