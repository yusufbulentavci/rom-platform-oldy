...
public class MailboxListFieldImpl extends AbstractField implements MailboxListField {
    ...
    /**
     * @see com.bilgidoku.rom.mime4j.dom.field.MailboxListField#getMailboxList()
     */
    ...
    /**
     * @see com.bilgidoku.rom.mime4j.dom.field.MailboxListField#getParseException()
     */
    @Override
