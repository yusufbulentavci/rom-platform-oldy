...
class TokenStoreImpl implements TokenStore {
  private static final String KEY = "oauth";

  public native void set(String key, String value) /*-{
    var obj = JSON.parse($wnd.localStorage.getItem(
        @com.bilgidoku.rom.site.kamu.login.client.oauth.TokenStoreImpl::KEY) || '{}');
    obj[key] = value;
    $wnd.localStorage.setItem(
        @com.bilgidoku.rom.site.kamu.login.client.oauth.TokenStoreImpl::KEY, JSON.stringify(obj));
  }-*/;

  public native String get(String key) /*-{
    return JSON.parse($wnd.localStorage.getItem(
        @com.bilgidoku.rom.site.kamu.login.client.oauth.TokenStoreImpl::KEY) || '{}')[key] || '';
  }-*/;
