...
class SpaceBoxRegistry extends InputBoxRegistry {
	...
	public InputBox create(Att att, String value) {
		return new SpaceContextBox(att, value);
	}

}

public class SpaceContextBox extends InputBox {

	private final Widget textBox;
	private final TextBox tf = new TextBox();

	protected SpaceContextBox(Att att, String value) {
		textBox = getTextBox(att.getNamed(), value);
		initWidget(textBox);
	}

	public SpaceContextBox(String name, String value) {
	...
	private Widget getTextBox(final String name, String value) {		
		...
		SiteButton cb = new SiteButton("/_local/images/common/resize_width.png", "", Ctrl.trans.size(), "");
			...
			public void onClick(ClickEvent event) {
				...
				bi.addCloseHandler(new CloseHandler<PopupPanel>() {
					...
					public void onClose(CloseEvent<PopupPanel> event) {
						...
						SpaceContextBox.this.fireEvent(new InputChanged(name, bi.selectedValue));
					}
				});
			}
		});
