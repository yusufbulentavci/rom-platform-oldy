...
import com.bilgidoku.rom.gwt.araci.client.site.Households;
import com.bilgidoku.rom.gwt.araci.client.site.HouseholdsDao;
import com.bilgidoku.rom.gwt.araci.client.site.HouseholdsResponse;
...
public class TabHouseHold extends Composite implements HasContent, HasResource, HasWidgets, HasTags {
	...
	public TabHouseHold(final String uri) {

		this.uri = uri;
		
		HouseholdsDao.get(Ctrl.infoLang(), uri, new HouseholdsResponse() {
			public void ready(Households value) {
				link = value;
...
//				HouseholdsDao.change(txtLinkedUri.getValue(), uri, new StringResponse() {
//					@Override
...
//				});
	...
	public void langChanged(final String lang) {
		HouseholdsDao.get(lang, this.uri, new HouseholdsResponse() {
			@Override
			public void ready(Households value) {
				link = value;
				pnlContent.load(value.uri, value.medium_icon, value.large_icon, value.icon, value.title[0],
