...
public class NavLinks extends NavBase implements HasContainer {
	...
	public NavLinks(boolean noToolbar, boolean showItems) {
	...
	public void addContainers() {
		...
		ContainersDao.listing("site", "links", "/_/c", new ContainersResponse() {
