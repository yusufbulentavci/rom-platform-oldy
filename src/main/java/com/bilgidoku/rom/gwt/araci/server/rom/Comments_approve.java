...
public class Comments_approve extends DbDaoBase{

	private final String callProto="select * from rom.comments_approve(?,?)";
	...
	private static final int rls=RoleMask.contact|RoleMask.admin|RoleMask.user;
