...
public class Yonetim_getPublic extends ServiceDaoBase{
	...
	public Yonetim_getPublic(){
		method=getMethod(com.bilgidoku.rom.web.admin.YonetimGorevlisi.class,"getPublic");
	}
