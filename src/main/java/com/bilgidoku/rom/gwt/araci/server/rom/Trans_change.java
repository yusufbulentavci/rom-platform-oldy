...
public class Trans_change extends DbDaoBase{

	private final String callProto="select * from rom.trans_change(?,?::rom.langs,?::rom.langs,?::json)";
		...
		TypeCoder titlesqlType=new JsonCoder();
