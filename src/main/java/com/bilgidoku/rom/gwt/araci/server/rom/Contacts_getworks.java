...
public class Contacts_getworks extends DbDaoBase{

	private final String callProto="select * from rom.contacts_getworks(?,?)";
	...
	TypeCoder coder=new ArrayCoder<Json>(new JsonCoder());
