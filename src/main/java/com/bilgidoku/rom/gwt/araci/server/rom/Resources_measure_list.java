...
public class Resources_measure_list extends DbDaoBase{

	private final String callProto="select * from rom.resources_measure_list(?,?,?)";
	...
	TypeCoder coder=new MeasureCoder();
