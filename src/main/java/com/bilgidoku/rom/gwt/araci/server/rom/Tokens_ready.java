...
public class Tokens_ready extends DbDaoBase{

	private final String callProto="select * from rom.tokens_ready(?,?)";

	private final BeforeHook beforeHook=getBeforeHook("com.bilgidoku.rom.web.db.tokens.ready");
