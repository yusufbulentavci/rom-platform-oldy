...
public class Yetkilendirme_forgetcontactpass extends ServiceDaoBase{
	...
	public Yetkilendirme_forgetcontactpass(){
		method=getMethod(com.bilgidoku.rom.web.authorize.YetkilendirmeGorevlisi.class,"forgetcontactpass");
	}

	@Override
	public Object call(CallInteraction request) throws KnownError, NotInlineMethodException, SecurityError, ParameterError {

		DenetimGorevlisi.tek().write(request.getHostId(),request.getSession().getCid(),request.getUri(),"/_auth.forgetcontactpass", auditParams, request.getAuditParams(auditParams));
