...
public class Info_browsertitle extends DbDaoBase{

	private final String callProto="select * from site.info_browsertitle(?,?::rom.langs,?::rom.langs,?)";
		...
		TypeCoder browsertitlesqlType=new StringCoder();
	...
	request.checkRole(rls);
		...
		try (DbThree db3 = new DbThree(callProto)) {
			String val;
				...
				val=request.getParam("browsertitle", null, null, false);
				browsertitlesqlType.setDbValue(db3, browsertitlesqlType.decode(val));
