...
public class Apps_change extends DbDaoBase{

	private final String callProto="select * from rom.apps_change(?,?,?,?::json,?,?::json)";
		...
		TypeCoder clssqlType=new IntegerCoder();
		TypeCoder statesqlType=new JsonCoder();
