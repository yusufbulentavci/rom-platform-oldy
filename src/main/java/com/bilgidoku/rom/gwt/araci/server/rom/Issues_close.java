...
public class Issues_close extends DbDaoBase{

	private final String callProto="select * from rom.issues_close(?,?,?,?,?,?,?::text[],?)";
	...
	private static final int rls=RoleMask.manager|RoleMask.admin;
