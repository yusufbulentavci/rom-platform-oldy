...
public class Yonetim_getPrivate extends ServiceDaoBase{
	...
	public Yonetim_getPrivate(){
		method=getMethod(com.bilgidoku.rom.web.admin.YonetimGorevlisi.class,"getPrivate");
	}
