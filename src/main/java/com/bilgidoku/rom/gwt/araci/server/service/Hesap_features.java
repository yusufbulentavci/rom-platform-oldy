...
public class Hesap_features extends ServiceDaoBase{

	String val;



	TypeCoder coder=new ArrayCoder<Feature>(new FeatureCoder());

	private static final int rls=RoleMask.author|RoleMask.admin|RoleMask.designer;

	private final Method method;
	public Hesap_features(){
		method=getMethod(com.bilgidoku.rom.web.account.HesapGorevlisi.class,"features");
	}
