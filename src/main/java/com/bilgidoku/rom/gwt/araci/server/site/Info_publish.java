...
public class Info_publish extends DbDaoBase{

	private final String callProto="select * from site.info_publish(?)";

	private final BeforeHook beforeHook=getBeforeHook("com.bilgidoku.rom.web.db.files.publish");
