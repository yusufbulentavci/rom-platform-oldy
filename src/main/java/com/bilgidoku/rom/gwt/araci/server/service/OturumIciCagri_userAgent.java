...
public class OturumIciCagri_userAgent extends ServiceDaoBase{
	...
	public OturumIciCagri_userAgent(){
		method=getMethod(com.bilgidoku.rom.web.sessionfuncs.OturumIciCagriGorevlisi.class,"userAgent");
	}
