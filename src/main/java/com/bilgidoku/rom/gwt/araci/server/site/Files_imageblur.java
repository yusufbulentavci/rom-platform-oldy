...
public class Files_imageblur extends DbDaoBase{

	private final String callProto="select * from site.files_imageblur(?,?)";

	private final BeforeHook beforeHook=getBeforeHook("com.bilgidoku.rom.web.db.image.blur");
