...
public class Issues_set_nesne extends DbDaoBase{

	private final String callProto="select * from rom.issues_set_nesne(?,?,?::int8[])";



		TypeCoder hostsqlType=new IntegerCoder();
		TypeCoder selfsqlType=new StringCoder();
		TypeCoder valsqlType=new ArrayCoder(new LongCoder());
