...
public class Yetkilendirme_logout extends ServiceDaoBase{
	...
	public Yetkilendirme_logout(){
		method=getMethod(com.bilgidoku.rom.web.authorize.YetkilendirmeGorevlisi.class,"logout");
	}

	@Override
	public Object call(CallInteraction request) throws KnownError, NotInlineMethodException, SecurityError, ParameterError {

		DenetimGorevlisi.tek().write(request.getHostId(),request.getSession().getCid(),request.getUri(),"/_auth.logout", auditParams, request.getAuditParams(auditParams));
