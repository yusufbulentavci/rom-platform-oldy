...
public class TagsCoder extends
	...
	public TagsCoder(){
		super(true,new String[]{"ri","host_id","uri","container","html_file","modified_date","creation_date","delegated","ownercid","gid","relatedcids","mask","nesting","dbfs","weight","lexemes","rtags","aa","langcodes","title","summary","parenttags"});
	}

	@Override
	public  Tags decode(Object js) throws JSONException  {
	...
	@Override
	public Object encode(Tags obj) throws JSONException {
	...
	@Override
	public void setDbValue(DbSetGet db3, Tags val) throws KnownError {
		if (val == null) {
		...
		new ArrayCoder<String>(new StringCoder()).setDbValue(db3,val.parenttags);

	}

	@Override
	public String toString(Tags val) throws KnownError {
		...
		sb.append(',');sb.append(new ArrayCoder<String>(new StringCoder()).quoted(val.parenttags));
	...
	@Override
	protected Tags inGetDbValue(DbSetGet db3) throws KnownError, JSONException {
		Tags val=new Tags();
		...
		val.parenttags=new ArrayCoder<String>(new StringCoder()).getDbValue(db3);

		return val;
	}

	public Tags fromString(String str) throws JSONException{
		if(str==null)
			return null;
		...
		val.parenttags=new ArrayCoder<String>(new StringCoder()).fromString(ms[i++]);
