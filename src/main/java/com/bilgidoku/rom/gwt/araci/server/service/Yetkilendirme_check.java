...
public class Yetkilendirme_check extends ServiceDaoBase{
	...
	public Yetkilendirme_check(){
		method=getMethod(com.bilgidoku.rom.web.authorize.YetkilendirmeGorevlisi.class,"check");
	}
