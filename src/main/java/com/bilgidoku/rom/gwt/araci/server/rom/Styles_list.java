...
public class Styles_list extends DbDaoBase{

	private final String callProto="select * from rom.styles_list(?,?)";
	...
	TypeCoder coder=new StylesCoder();


	private static final int rls=RoleMask.admin|RoleMask.designer;
