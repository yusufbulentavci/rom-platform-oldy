...
public class Exams_start extends DbDaoBase{

	private final String callProto="select * from site.exams_start(?,?,?::rom.langs,?::rom.langs,?)";
	...
	TypeCoder coder=new ExamsCoder();
