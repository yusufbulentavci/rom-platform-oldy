...
public class Resources_setrelatedcids extends DbDaoBase{

	private final String callProto="select * from rom.resources_setrelatedcids(?,?,?)";



		TypeCoder hostsqlType=new IntegerCoder();
		TypeCoder selfsqlType=new StringCoder();
		TypeCoder relatedcidssqlType=new StringCoder();
