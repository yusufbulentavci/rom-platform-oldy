...
public class Files_imagemakepng extends DbDaoBase{

	private final String callProto="select * from site.files_imagemakepng(?,?,?)";

	private final BeforeHook beforeHook=getBeforeHook("com.bilgidoku.rom.web.db.image.makepng");
