...
public class StocksCoder extends
	...
	public StocksCoder(){
		super(true,new String[]{"ri","host_id","uri","container","html_file","modified_date","creation_date","delegated","ownercid","gid","relatedcids","mask","nesting","dbfs","weight","lexemes","rtags","aa","writing","tariff","physical","reserved","amount","alertonleft","onsale","options","firststock","alternatives","virtualsparent","title","summary","tariffmodel","icon"});
	}

	@Override
	public  Stocks decode(Object js) throws JSONException  {
	...
	@Override
	public Object encode(Stocks obj) throws JSONException {
	...
	@Override
	public void setDbValue(DbSetGet db3, Stocks val) throws KnownError {
		if (val == null) {
	...
	@Override
	public String toString(Stocks val) throws KnownError {
	...
	@Override
	protected Stocks inGetDbValue(DbSetGet db3) throws KnownError, JSONException {
		Stocks val=new Stocks();
	...
	public Stocks fromString(String str) throws JSONException{
		if(str==null)
			return null;
