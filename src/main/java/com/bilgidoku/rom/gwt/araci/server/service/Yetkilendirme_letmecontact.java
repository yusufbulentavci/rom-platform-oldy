...
public class Yetkilendirme_letmecontact extends ServiceDaoBase{
	...
	public Yetkilendirme_letmecontact(){
		method=getMethod(com.bilgidoku.rom.web.authorize.YetkilendirmeGorevlisi.class,"letmecontact");
	}
