...
public class OturumIciCagri_hasDomain extends ServiceDaoBase{
	...
	public OturumIciCagri_hasDomain(){
		method=getMethod(com.bilgidoku.rom.web.sessionfuncs.OturumIciCagriGorevlisi.class,"hasDomain");
	}
