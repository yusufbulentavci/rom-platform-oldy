...
public class Cart_setpaystyle extends DbDaoBase{

	private final String callProto="select * from site.cart_setpaystyle(?,?,?)";



		TypeCoder hostsqlType=new IntegerCoder();
		TypeCoder selfsqlType=new StringCoder();
		TypeCoder paystylesqlType=new StringCoder();
