...
public class Hesap_hostfeatures extends ServiceDaoBase{

	String val;



	TypeCoder coder=new ArrayCoder<HostFeature>(new HostFeatureCoder());

	private static final int rls=RoleMask.author|RoleMask.admin|RoleMask.designer;

	private final Method method;
	public Hesap_hostfeatures(){
		method=getMethod(com.bilgidoku.rom.web.account.HesapGorevlisi.class,"hostfeatures");
	}
