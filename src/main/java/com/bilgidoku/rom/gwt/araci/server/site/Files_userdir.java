...
public class Files_userdir extends DbDaoBase{

	private final String callProto="select * from site.files_userdir(?,?)";



		TypeCoder hostsqlType=new IntegerCoder();
		TypeCoder contactnosqlType=new StringCoder();
