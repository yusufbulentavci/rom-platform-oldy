...
public class OturumIciCagri_rtpresence extends ServiceDaoBase{

	String val;

		
		TypeCoder presencesqlType=new StringCoder();
		
		TypeCoder codesqlType=new IntegerCoder();
	...
	public OturumIciCagri_rtpresence(){
		method=getMethod(com.bilgidoku.rom.web.sessionfuncs.OturumIciCagriGorevlisi.class,"rtpresence");
	}
	...
	public Object call(CallInteraction request) throws KnownError, NotInlineMethodException, SecurityError, ParameterError {
		...
		val=request.getParam("presence", null, null, false);
		args[ind++]=presencesqlType.decode(val);
