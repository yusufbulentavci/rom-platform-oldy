...
public class Files_undo extends DbDaoBase{

	private final String callProto="select * from site.files_undo(?,?)";

	private final BeforeHook beforeHook=getBeforeHook("com.bilgidoku.rom.web.db.files.undo");
