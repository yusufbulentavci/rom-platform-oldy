...
public class Households_get extends DbDaoBase{

	private final String callProto="select * from site.households_get(?,?,?::rom.langs,?::rom.langs)";
	...
	TypeCoder coder=new HouseholdsCoder();
