...
public class Info_sitefooter extends DbDaoBase{

	private final String callProto="select * from site.info_sitefooter(?,?::rom.langs,?::rom.langs,?::json)";
		...
		TypeCoder sitefootersqlType=new JsonCoder();
	...
	request.checkRole(rls);
		...
		try (DbThree db3 = new DbThree(callProto)) {
			String val;
				...
				val=request.getParam("sitefooter", null, null, false);
				sitefootersqlType.setDbValue(db3, sitefootersqlType.decode(val));
