...
public class SiteInfo_startssl extends ServiceDaoBase{
	...
	public SiteInfo_startssl(){
		method=getMethod(com.bilgidoku.rom.web.info.SiteInfoGorevlisi.class,"startssl");
	}
