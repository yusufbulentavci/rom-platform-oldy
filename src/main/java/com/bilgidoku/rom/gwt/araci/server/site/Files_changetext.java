...
public class Files_changetext extends DbDaoBase{

	private final String callProto="select * from site.files_changetext(?,?,?)";

	private final BeforeHook beforeHook=getBeforeHook("com.bilgidoku.rom.web.db.files.changetext");
