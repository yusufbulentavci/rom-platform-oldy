...
public class Issues_set_nesnetags extends DbDaoBase{

	private final String callProto="select * from rom.issues_set_nesnetags(?,?,?::text[])";



		TypeCoder hostsqlType=new IntegerCoder();
		TypeCoder selfsqlType=new StringCoder();
		TypeCoder valsqlType=new ArrayCoder(new StringCoder());
