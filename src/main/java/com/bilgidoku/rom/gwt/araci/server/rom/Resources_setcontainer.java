...
public class Resources_setcontainer extends DbDaoBase{

	private final String callProto="select * from rom.resources_setcontainer(?,?,?)";



		TypeCoder hostsqlType=new IntegerCoder();
		TypeCoder selfsqlType=new StringCoder();
		TypeCoder iscontsqlType=new BooleanCoder();
