...
public class StylesCoder extends
		TypeCoder<Styles> {
	...
	@Override
	public  Styles decode(Object js) throws JSONException  {
	...
	@Override
	public Object encode(Styles obj) throws JSONException {
	...
	@Override
	public  Styles[] createArray(int size) {
		return new  Styles[size];
	}

	@Override
	public void setDbValue(DbSetGet db3, Styles val) throws KnownError {
		if (val == null) {
	...
	@Override
	public String toString(Styles val) throws KnownError {
	...
	@Override
	protected Styles inGetDbValue(DbSetGet db3) throws KnownError, JSONException {
	...
	public Styles fromString(String str) throws JSONException{
		if(str==null)
			return null;
