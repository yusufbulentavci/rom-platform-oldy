...
public class Hosgeldin_sitesof extends ServiceDaoBase{
	...
	TypeCoder coder=new ArrayCoder<Welcome>(new WelcomeCoder());


	private final Method method;
	public Hosgeldin_sitesof(){
		method=getMethod(com.bilgidoku.rom.web.welcome.HosgeldinGorevlisi.class,"sitesof");
	}
