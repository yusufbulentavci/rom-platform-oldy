...
public class ResourcesCoder extends
		TypeCoder<Resources> {
	...
	@Override
	public  Resources decode(Object js) throws JSONException  {
	...
	@Override
	public Object encode(Resources obj) throws JSONException {
	...
	@Override
	public  Resources[] createArray(int size) {
		return new  Resources[size];
	}

	@Override
	public void setDbValue(DbSetGet db3, Resources val) throws KnownError {
		if (val == null) {
	...
	@Override
	public String toString(Resources val) throws KnownError {
	...
	@Override
	protected Resources inGetDbValue(DbSetGet db3) throws KnownError, JSONException {
		Resources val=new Resources();
	...
	public Resources fromString(String str) throws JSONException{
		if(str==null)
			return null;
