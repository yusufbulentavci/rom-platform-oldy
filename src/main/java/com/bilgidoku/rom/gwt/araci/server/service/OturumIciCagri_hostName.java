...
public class OturumIciCagri_hostName extends ServiceDaoBase{
	...
	public OturumIciCagri_hostName(){
		method=getMethod(com.bilgidoku.rom.web.sessionfuncs.OturumIciCagriGorevlisi.class,"hostName");
	}
