...
public class Files_extinct extends DbDaoBase{

	private final String callProto="select * from site.files_extinct(?,?)";

	private final BeforeHook beforeHook=getBeforeHook("com.bilgidoku.rom.web.db.files.delfile");
