...
public class HouseholdsDao extends DaoBase{
	// dbmethodrender
	...
	StringResponse methodResp
			...
			// dbmethodrender
	public static void change(Boolean aktifmi,String baslangic,String bitis,String self  , 
	StringResponse methodResp
	) {
			...
			new StringCoder()
					...
					methodResp.addParam("aktifmi",new BooleanCoder().encode(aktifmi));
					methodResp.addParam("baslangic",new StringCoder().encode(baslangic));
					methodResp.addParam("bitis",new StringCoder().encode(bitis));
	...
	ContainersResponse methodResp
			...
			new ContainersCoder()
				...
				final String table="households";
				methodResp.addParam("table",new JSONString("households"));
