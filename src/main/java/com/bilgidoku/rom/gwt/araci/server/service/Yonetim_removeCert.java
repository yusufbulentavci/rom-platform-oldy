...
public class Yonetim_removeCert extends ServiceDaoBase{
	...
	public Yonetim_removeCert(){
		method=getMethod(com.bilgidoku.rom.web.admin.YonetimGorevlisi.class,"removeCert");
	}
