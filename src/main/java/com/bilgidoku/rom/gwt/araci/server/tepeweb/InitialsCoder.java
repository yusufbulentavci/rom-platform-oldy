...
public class InitialsCoder extends
		TypeCoder<Initials> {

	public InitialsCoder(){
		super(true,new String[]{"ri","host_id","uri","container","html_file","modified_date","creation_date","delegated","ownercid","gid","relatedcids","mask","nesting","dbfs","weight","lexemes","rtags","aa"});
	}

	@Override
	public  Initials decode(Object js) throws JSONException  {
		JSONObject json = getObject(js);
		if(json==null)
			return null;
		 Initials c=new Initials();
	...
	@Override
	public Object encode(Initials obj) throws JSONException {
	...
	@Override
	public  Initials[] createArray(int size) {
		return new  Initials[size];
	}

	@Override
	public void setDbValue(DbSetGet db3, Initials val) throws KnownError {
		if (val == null) {
	...
	@Override
	public String toString(Initials val) throws KnownError {
	...
	@Override
	protected Initials inGetDbValue(DbSetGet db3) throws KnownError, JSONException {
		Initials val=new Initials();
	...
	public Initials fromString(String str) throws JSONException{
		if(str==null)
			return null;
