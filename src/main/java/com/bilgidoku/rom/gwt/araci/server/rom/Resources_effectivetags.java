...
public class Resources_effectivetags extends DbDaoBase{

	private final String callProto="select * from rom.resources_effectivetags(?,?)";
	...
	TypeCoder coder=new ArrayCoder<String>(new StringCoder());
