...
public class Resources_exists extends DbDaoBase{

	private final String callProto="select * from rom.resources_exists(?,?)";
	...
	private static final int rls=RoleMask.owner|RoleMask.author|RoleMask.contact|RoleMask.admin;
