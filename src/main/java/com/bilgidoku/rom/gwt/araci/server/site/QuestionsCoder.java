...
public class QuestionsCoder extends
		TypeCoder<Questions> {

	public QuestionsCoder(){
		super(true,new String[]{"ri","host_id","uri","container","html_file","modified_date","creation_date","delegated","ownercid","gid","relatedcids","mask","nesting","dbfs","weight","lexemes","rtags","aa","title","summary","tip","icon","medium_icon","large_icon","multilang_icon","sound","langcodes","viewy","option_a","option_b","option_c","option_d","option_e","option_count","correct_option"});
	}

	@Override
	public  Questions decode(Object js) throws JSONException  {
		...
		c.option_a=new ArrayCoder<String>(new StringCoder()).decode(json.get("option_a"));
		c.option_b=new ArrayCoder<String>(new StringCoder()).decode(json.get("option_b"));
		c.option_c=new ArrayCoder<String>(new StringCoder()).decode(json.get("option_c"));
		c.option_d=new ArrayCoder<String>(new StringCoder()).decode(json.get("option_d"));
		c.option_e=new ArrayCoder<String>(new StringCoder()).decode(json.get("option_e"));
		c.option_count=new IntegerCoder().decode(json.get("option_count"));
		c.correct_option=new IntegerCoder().decode(json.get("correct_option"));
	...
	@Override
	public Object encode(Questions obj) throws JSONException {
		...
		js.put("option_a",new ArrayCoder<String>(new StringCoder()).encode(obj.option_a));
		js.put("option_b",new ArrayCoder<String>(new StringCoder()).encode(obj.option_b));
		js.put("option_c",new ArrayCoder<String>(new StringCoder()).encode(obj.option_c));
		js.put("option_d",new ArrayCoder<String>(new StringCoder()).encode(obj.option_d));
		js.put("option_e",new ArrayCoder<String>(new StringCoder()).encode(obj.option_e));
		js.put("option_count",new IntegerCoder().encode(obj.option_count));
		js.put("correct_option",new IntegerCoder().encode(obj.correct_option));

		return js;
	}

	@Override
	public  Questions[] createArray(int size) {
		return new  Questions[size];
	}

	@Override
	public void setDbValue(DbSetGet db3, Questions val) throws KnownError {
		if (val == null) {
		...
		new ArrayCoder<String>(new StringCoder()).setDbValue(db3,val.option_a);
		new ArrayCoder<String>(new StringCoder()).setDbValue(db3,val.option_b);
		new ArrayCoder<String>(new StringCoder()).setDbValue(db3,val.option_c);
		new ArrayCoder<String>(new StringCoder()).setDbValue(db3,val.option_d);
		new ArrayCoder<String>(new StringCoder()).setDbValue(db3,val.option_e);
		new IntegerCoder().setDbValue(db3,val.option_count);
		new IntegerCoder().setDbValue(db3,val.correct_option);

	}

	@Override
	public String toString(Questions val) throws KnownError {
		...
		sb.append(',');sb.append(new ArrayCoder<String>(new StringCoder()).quoted(val.option_a));
		sb.append(',');sb.append(new ArrayCoder<String>(new StringCoder()).quoted(val.option_b));
		sb.append(',');sb.append(new ArrayCoder<String>(new StringCoder()).quoted(val.option_c));
		sb.append(',');sb.append(new ArrayCoder<String>(new StringCoder()).quoted(val.option_d));
		sb.append(',');sb.append(new ArrayCoder<String>(new StringCoder()).quoted(val.option_e));
		sb.append(',');sb.append(new IntegerCoder().quoted(val.option_count));
		sb.append(',');sb.append(new IntegerCoder().quoted(val.correct_option));
	...
	@Override
	protected Questions inGetDbValue(DbSetGet db3) throws KnownError, JSONException {
		Questions val=new Questions();
		...
		val.option_a=new ArrayCoder<String>(new StringCoder()).getDbValue(db3);
		val.option_b=new ArrayCoder<String>(new StringCoder()).getDbValue(db3);
		val.option_c=new ArrayCoder<String>(new StringCoder()).getDbValue(db3);
		val.option_d=new ArrayCoder<String>(new StringCoder()).getDbValue(db3);
		val.option_e=new ArrayCoder<String>(new StringCoder()).getDbValue(db3);
		val.option_count=new IntegerCoder().getDbValue(db3);
		val.correct_option=new IntegerCoder().getDbValue(db3);

		return val;
	}

	public Questions fromString(String str) throws JSONException{
		if(str==null)
			return null;
		...
		val.option_a=new ArrayCoder<String>(new StringCoder()).fromString(ms[i++]);
		val.option_b=new ArrayCoder<String>(new StringCoder()).fromString(ms[i++]);
		val.option_c=new ArrayCoder<String>(new StringCoder()).fromString(ms[i++]);
		val.option_d=new ArrayCoder<String>(new StringCoder()).fromString(ms[i++]);
		val.option_e=new ArrayCoder<String>(new StringCoder()).fromString(ms[i++]);
		val.option_count=new IntegerCoder().fromString(ms[i++]);
		val.correct_option=new IntegerCoder().fromString(ms[i++]);
