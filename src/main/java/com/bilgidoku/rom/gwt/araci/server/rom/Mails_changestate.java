...
public class Mails_changestate extends DbDaoBase{

	private final String callProto="select * from rom.mails_changestate(?,?,?)";



		TypeCoder hostsqlType=new IntegerCoder();
		TypeCoder selfsqlType=new StringCoder();
		TypeCoder statesqlType=new IntegerCoder();
