...
public class Hesap_tariffs extends ServiceDaoBase{

	String val;



	TypeCoder coder=new ArrayCoder<Tariff>(new TariffCoder());

	private static final int rls=RoleMask.author|RoleMask.admin|RoleMask.designer;

	private final Method method;
	public Hesap_tariffs(){
		method=getMethod(com.bilgidoku.rom.web.account.HesapGorevlisi.class,"tariffs");
	}
