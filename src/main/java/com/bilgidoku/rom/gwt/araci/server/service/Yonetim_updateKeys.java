...
public class Yonetim_updateKeys extends ServiceDaoBase{
	...
	public Yonetim_updateKeys(){
		method=getMethod(com.bilgidoku.rom.web.admin.YonetimGorevlisi.class,"updateKeys");
	}
