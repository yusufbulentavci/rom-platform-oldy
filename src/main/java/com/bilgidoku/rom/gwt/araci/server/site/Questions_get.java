...
public class Questions_get extends DbDaoBase{

	private final String callProto="select * from site.questions_get(?,?,?::rom.langs,?::rom.langs)";
	...
	TypeCoder coder=new QuestionsCoder();
