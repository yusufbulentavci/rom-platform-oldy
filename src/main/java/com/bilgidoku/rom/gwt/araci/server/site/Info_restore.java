...
public class Info_restore extends DbDaoBase{

	private final String callProto="select * from site.info_restore(?)";

	private final BeforeHook beforeHook=getBeforeHook("com.bilgidoku.rom.web.db.files.restore");
