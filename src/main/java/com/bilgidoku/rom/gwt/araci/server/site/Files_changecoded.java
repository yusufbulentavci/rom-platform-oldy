...
public class Files_changecoded extends DbDaoBase{

	private final String callProto="select * from site.files_changecoded(?,?,?)";

	private final BeforeHook beforeHook=getBeforeHook("com.bilgidoku.rom.web.db.files.changecoded");
