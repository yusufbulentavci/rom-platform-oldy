...
public class Resources_removefile extends DbDaoBase{

	private final String callProto="select * from rom.resources_removefile(?,?,?)";

	private final BeforeHook beforeHook=getBeforeHook("com.bilgidoku.rom.web.db.files.dbfsdel");
