...
public class Files_imagesharpen extends DbDaoBase{

	private final String callProto="select * from site.files_imagesharpen(?,?)";

	private final BeforeHook beforeHook=getBeforeHook("com.bilgidoku.rom.web.db.image.sharpen");
