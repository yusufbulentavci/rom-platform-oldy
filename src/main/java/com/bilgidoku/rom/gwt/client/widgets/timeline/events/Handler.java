 ...
 * the License.
 */
package com.bilgidoku.rom.gwt.client.widgets.timeline.events;
...
public abstract class Handler {
  ...
  public static native void addHandler(Visualization<?> viz, String eventName,
    ...
    var callback = function(event) {
      @com.bilgidoku.rom.gwt.client.widgets.timeline.events.Handler::onCallback(Lcom/bilgidoku/rom/gwt/client/widgets/timeline/events/Handler;Lcom/google/gwt/ajaxloader/client/Properties;)
          (handler, event);
    };
