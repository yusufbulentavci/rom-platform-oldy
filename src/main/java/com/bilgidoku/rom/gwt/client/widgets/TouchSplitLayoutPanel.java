...
public class TouchSplitLayoutPanel extends DockLayoutPanel {
                ...
                case Event.ONTOUCHMOVE:
                    if (mouseDown) {
                        ...
                        if (reverse) {
                            ...
                            int aOffset = offset;
                            size = targetPosition + targetSize - eventPosition - aOffset;
                        }
                        if (!reverse) {
                            int targetPosition = getTargetPosition();
                            int eventPosition = getEventPosition(event);
                            int aOffset = offset;
                            size = eventPosition - targetPosition - aOffset;
                        }
    ...
    /**
     * Construct a new {@link TouchSplitLayoutPanel} with the default splitter size of
     * 8px.
     */
    ...
    /**
     * Construct a new {@link TouchSplitLayoutPanel} with the specified splitter size
     * in pixels.
     *
