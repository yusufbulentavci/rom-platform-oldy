...
import com.bilgidoku.rom.gwt.client.widgets.timeline.events.RangeChangeHandler;
import com.bilgidoku.rom.gwt.client.widgets.timeline.events.RangeChangedHandler;
import com.bilgidoku.rom.gwt.client.widgets.timeline.events.ReadyHandler;
import com.bilgidoku.rom.gwt.client.widgets.timeline.events.SelectHandler;
import com.bilgidoku.rom.gwt.client.widgets.timeline.events.TimeChangeHandler;
import com.bilgidoku.rom.gwt.client.widgets.timeline.events.TimeChangedHandler;
...
public class Timeline extends Visualization<Timeline.Options> implements
	...
	private native void nativeSetScale(JavaScriptObject jso,
		...
		var jsScale;
		switch (scale) {
		case @com.bilgidoku.rom.gwt.client.widgets.timeline.Timeline.Options.SCALE::MILLISECOND:
			jsScale = $wnd.links.Timeline.StepDate.SCALE.MILLISECOND;
			break;
		case @com.bilgidoku.rom.gwt.client.widgets.timeline.Timeline.Options.SCALE::SECOND:
			jsScale = $wnd.links.Timeline.StepDate.SCALE.SECOND;
			break;
		case @com.bilgidoku.rom.gwt.client.widgets.timeline.Timeline.Options.SCALE::MINUTE:
			jsScale = $wnd.links.Timeline.StepDate.SCALE.MINUTE;
			break;
		case @com.bilgidoku.rom.gwt.client.widgets.timeline.Timeline.Options.SCALE::HOUR:
			jsScale = $wnd.links.Timeline.StepDate.SCALE.HOUR;
			break;
		case @com.bilgidoku.rom.gwt.client.widgets.timeline.Timeline.Options.SCALE::DAY:
			jsScale = $wnd.links.Timeline.StepDate.SCALE.DAY;
			break;
		case @com.bilgidoku.rom.gwt.client.widgets.timeline.Timeline.Options.SCALE::MONTH:
			jsScale = $wnd.links.Timeline.StepDate.SCALE.MONTH;
			break;
		case @com.bilgidoku.rom.gwt.client.widgets.timeline.Timeline.Options.SCALE::YEAR:
