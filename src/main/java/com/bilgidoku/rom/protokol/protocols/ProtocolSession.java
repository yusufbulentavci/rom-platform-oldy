 ...
 *
 */
public interface ProtocolSession<PSA extends ProtocolSessionActivity> extends CommonSession {
...
//    Map<String,Object> getConnectionState();
     ...
     */
    void setProtocolUser(String user);
     ...
     */
    <T extends ProtocolSession<PSA>> void pushLineHandler(LineHandler<T> overrideCommandHandler);
	...
	Collection<ByteBuffer> getBufferedLines();
	Collection<ByteBuffer> setBufferedLines(Collection<ByteBuffer> lines);
	
	void loggedIn(RomUser user) throws KnownError;
