 ...
 *
 */
public abstract class ProtocolConfigurationImpl implements ProtocolConfiguration {
    
    final public String getHelloName() {
    	return Genel.getHostName();
    }
    
    
    final public String getGreeting() {
        return Genel.getHostName();
    }
