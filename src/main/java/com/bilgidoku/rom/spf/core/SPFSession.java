...
package com.bilgidoku.rom.spf.core;
...
//    private Map<String,Object> attributes = new HashMap<String,Object>();
	...
	private String macroExpandCheckReport;

	private DNSLookupContinuation stagedExecCont;

	private SPF1Record spf1Record;

	private String explaintPolicy;

	private List<String> strictCheckRecords;

	private Boolean ipv4Check;

	private Boolean mechResult;

	private String expandExplain;

	private List<String> checkRecords;
...
//    }
	...
	public void setMacroExpandCheckReport(String record) {
		this.macroExpandCheckReport=record;
	}

	public String getMacroExpandCheckReport() {
		return this.macroExpandCheckReport;
	}

	public void setStagedExecCont(DNSLookupContinuation cont) {
		this.stagedExecCont=cont;
	}
	
	public DNSLookupContinuation getStagedExecCont() {
		return this.stagedExecCont;
	}

	public SPF1Record getSpf1Record() {
		return this.spf1Record;
	}

	public void setSpf1Record(SPF1Record res) {
		this.spf1Record=res;
	}

	public String getExplainPolicy() {
		return this.explaintPolicy;
	}

	public void setExplaintPolicy(String explanation2) {
		this.explaintPolicy=explanation2;
	}

	public List<String> getStrictCheckRecords() {
		return strictCheckRecords;
	}

	public void setStrictCheckRecords(List<String> spfR) {
		this.strictCheckRecords=spfR;
	}

	public void setIpv4Check(Boolean valueOf) {
		this.ipv4Check=valueOf;
	}

	public void setMechResult(Boolean false1) {
		this.mechResult=false1;
	}

	public Boolean getIpv4Check() {
		return ipv4Check;
	}

	public Boolean getMechResult() {
		return this.mechResult;
	}

	public String getExpandExplain() {
		return this.expandExplain;
	}

	public void setExpandExplain(String exp) {
		this.expandExplain=exp;
	}

	public List<String> getCheckRecords() {
		return checkRecords;
	}
	...
	public void setCheckRecords(List<String> records) {
		this.checkRecords=records;
	}

	public void setMxRecords(List<String> mxR) {
		mxRecords=mxR;
	}

	public void setExpandedHost(String host) {
		expandedHost=host;
	}
	...
	public void setDomainList(List<String> domainList2) {
		domainList=domainList2;
	}

	public String getExpandedHost() {
		return expandedHost;
	}
