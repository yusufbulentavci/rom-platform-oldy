...
public class StagedMultipleSPFExecutor implements SPFExecutor, Runnable {
    ...
    public StagedMultipleSPFExecutor(DNSAsynchLookupService service) {
        ...
        this.worker = KosuGorevlisi.tek().thread(this,"spf");
//        this.worker.setDaemon(true);
        this.worker.setName(Genel.uniqueName("SPFExecutor"));
        this.worker.start();
    }
    ...
    private synchronized void invokeAsynchService(SPFSession session,
        ...
        session.setStagedExecCont(cont);
    ...
    public void run() {
        ...
        while (true) {
            ...
            DNSLookupContinuation cont = session.getStagedExecCont();
