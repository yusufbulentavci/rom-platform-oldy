...
public abstract class AbstractRecipientMatcher extends AbstractMatcher {
    ...
    public AbstractRecipientMatcher(MailProcessContext context, MatcherConfig config) {
     ...
     * @throws KnownError 
     */
    public final Collection<MailAddress> match(Email mail) throws KnownError {
     ...
     * @throws KnownError 
     */
    public abstract boolean matchRecipient(MailAddress recipient) throws KnownError;
}
