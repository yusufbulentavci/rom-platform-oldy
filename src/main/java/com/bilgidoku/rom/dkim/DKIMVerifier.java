...
import com.bilgidoku.rom.dkim.api.PublicKeyRecord;
import com.bilgidoku.rom.dkim.api.PublicKeyRecordRetriever;
import com.bilgidoku.rom.dkim.api.SignatureRecord;
import com.bilgidoku.rom.dkim.exceptions.FailException;
import com.bilgidoku.rom.dkim.exceptions.PermFailException;
import com.bilgidoku.rom.dkim.exceptions.TempFailException;
import com.bilgidoku.rom.dkim.tagvalue.PublicKeyRecordImpl;
import com.bilgidoku.rom.dkim.tagvalue.SignatureRecordImpl;
...
public class DKIMVerifier extends DKIMCommon {
    ...
    public PublicKeyRecord publicRecordLookup(SignatureRecord sign)
        ...
        // com.bilgidoku.rom.runtime.log.Sistem.outln(sign);
    ...
    private List<SignatureRecord> verify(CompoundBodyHasher compoundBodyHasher)
        ...
        if (verifiedSignatures.isEmpty()) {
            ...
            for (Iterator i = signatureExceptions.keySet().iterator(); i
                ...
                com.bilgidoku.rom.runtime.log.Sistem.outln("DKIM-Error:"
            ...
            */
            ...
            for (Iterator i = verifiedSignatures.iterator(); i.hasNext();) {
                ...
                com.bilgidoku.rom.runtime.log.Sistem.outln("DKIM-Pass:" + sr);
            }
            */
    ...
    private FailException prepareException(Map<String, FailException> signatureExceptions) {
        if (signatureExceptions.size() == 1) {
            ...
            // com.bilgidoku.rom.runtime.log.Sistem.outln(signatureExceptions);
