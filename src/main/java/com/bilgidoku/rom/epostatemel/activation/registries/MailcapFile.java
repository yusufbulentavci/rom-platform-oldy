...
import com.bilgidoku.rom.epostatemel.activation.registries.MailcapParseException;
import com.bilgidoku.rom.epostatemel.activation.registries.MailcapTokenizer;
...
public class MailcapFile {
	...
	if (LogSupport.isLoggable())
     ...
     public static void	main(String[] args) throws Exception {
	    ...
	    com.bilgidoku.rom.gunluk.Sistem.outln("Entry " + i + ": " + args[i]);
	    ...
	    com.bilgidoku.rom.gunluk.Sistem.outln("MIME Type: " + key);
		...
		com.bilgidoku.rom.gunluk.Sistem.outln("    Command: " + command);

		Vector classes = (Vector)commandHash.get(command);
		for (int i = 0; i < classes.size(); ++i) {
			com.bilgidoku.rom.gunluk.Sistem.outln("        Class: " +
