...
package com.bilgidoku.rom.epostatemel.activation.viewers;
...
import com.bilgidoku.rom.epostatemel.javam.activation.CommandObject;
...
public class TextEditor extends Panel implements CommandObject,
   ...
   */
	...
	if(fos == null) {
	    Sistem.outln("Invalid outputstream in TextEditor!");
	    Sistem.outln("not saving!");
	}
	...
	try {
	    ...
	    {
		Sistem.outln("TextEditor Save Operation failed with: " + e);
	    }
