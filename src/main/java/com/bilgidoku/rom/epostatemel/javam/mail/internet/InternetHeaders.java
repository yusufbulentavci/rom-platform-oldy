 ...
 * {@link com.bilgidoku.rom.epostatemel.javam.mail.Header} objects. <p>
 *
...
public class InternetHeaders {
     ...
     * {@link com.bilgidoku.rom.epostatemel.javam.mail.Header} objects.
     *
    ...
    /**
     * Return all matching {@link com.bilgidoku.rom.epostatemel.javam.mail.Header} objects.
     *
    ...
    /**
     * Return all non-matching {@link com.bilgidoku.rom.epostatemel.javam.mail.Header} objects.
     *
     ...
     * @param	line	raw RFC822 header line
     */
    public void addHeadHeaderLine(String line) {
	try {
	    
		headers.add(0,new InternetHeader(line));
	} catch (StringIndexOutOfBoundsException e) {
	    // line is empty, ignore it
	    return;
	} catch (NoSuchElementException e) {
