 ...
 *	com.bilgidoku.rom.gunluk.Sistem.outln("DELETED message");
 *
 ...
 *            com.bilgidoku.rom.gunluk.Sistem.outln("SEEN message");
 *      ......
 *      ......
 * }
 * </pre>
...
public class Flags implements Cloneable, Serializable {
    ...
    private final static int SENT_BIT		= 0x40;//64
	...
	if (f1.equals(fc) && fc.equals(f1))
	    com.bilgidoku.rom.gunluk.Sistem.outln("success");
	else
	    com.bilgidoku.rom.gunluk.Sistem.outln("fail");
	...
	for (int i = 0; i < s.length; i++)
	    com.bilgidoku.rom.gunluk.Sistem.outln(s[i]);
	com.bilgidoku.rom.gunluk.Sistem.outln("----------------");
	s = f2.getUserFlags();
	for (int i = 0; i < s.length; i++)
	    com.bilgidoku.rom.gunluk.Sistem.outln(s[i]);
	...
	if (f1.equals(f3))
	    com.bilgidoku.rom.gunluk.Sistem.outln("equals success");
	else
	    com.bilgidoku.rom.gunluk.Sistem.outln("fail");
	if (f3.equals(f1))
	    com.bilgidoku.rom.gunluk.Sistem.outln("equals success");
	    ...
	    com.bilgidoku.rom.gunluk.Sistem.outln("fail");
	com.bilgidoku.rom.gunluk.Sistem.outln("f1 hash code " + f1.hashCode());
	com.bilgidoku.rom.gunluk.Sistem.outln("f3 hash code " + f3.hashCode());
    ...
    ****/
	...
	public int getSystemFlagsInt() {
		return system_flags;
	}

	public void setSystemFlags(int int1) {
		this.system_flags=int1;
	}
}
