...
import com.bilgidoku.rom.epostatemel.javam.activation.MimeTypeParameterList;
...
public class MimeType implements Externalizable {
    ...
    public static void main(String[] args)
        ...
        for (int i = 0; i < args.length; ++i) {
            ...
            com.bilgidoku.rom.gunluk.Sistem.outln("Short:    " + type.getBaseType());
            com.bilgidoku.rom.gunluk.Sistem.outln("Parsed:   " + type.toString());
