...
public class InternetAddress extends Address implements Cloneable {
	...
	for (int i = 0; i < argv.length; i++) {
		...
		com.bilgidoku.rom.gunluk.Sistem.outln("arg " + i + " address " + j + ": " + a[j]);
		com.bilgidoku.rom.gunluk.Sistem.outln("\tAddress: " + a[j].getAddress() +
				    "\tPersonal: " + a[j].getPersonal());
	    }
	    if (a.length > 1) {
		com.bilgidoku.rom.gunluk.Sistem.outln("address 0 hash code: " + a[0].hashCode());
		com.bilgidoku.rom.gunluk.Sistem.outln("address 1 hash code: " + a[1].hashCode());
		...
		if (a[0].equals(a[1]))
		    com.bilgidoku.rom.gunluk.Sistem.outln("success, addresses equal");
		else
		    com.bilgidoku.rom.gunluk.Sistem.outln("fail, addresses not equal");
		if (a[1].equals(a[0]))
		    com.bilgidoku.rom.gunluk.Sistem.outln("success, addresses equal");
		else
		    com.bilgidoku.rom.gunluk.Sistem.outln("fail, addresses not equal");
