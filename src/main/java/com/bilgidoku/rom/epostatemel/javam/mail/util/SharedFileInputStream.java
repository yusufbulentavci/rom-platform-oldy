...
package com.bilgidoku.rom.epostatemel.javam.mail.util;

import java.io.*;

import com.bilgidoku.rom.epostatemel.javam.mail.internet.SharedInputStream;
...
//com.bilgidoku.rom.gunluk.Sistem.outln("getPosition: start " + start + " pos " + pos + " bufpos " + bufpos + " = " + (bufpos + pos - start));
	if (in == null)
