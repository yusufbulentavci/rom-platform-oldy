...
import com.bilgidoku.rom.epostatemel.javam.mail.MessageAware;
import com.bilgidoku.rom.epostatemel.javam.mail.MessageContext;
...
import com.bilgidoku.rom.epostatemel.javam.mail.MultipartDataSource;
...
//    public MimeMultipart(AttachDeal attachAdder, JSONArray jo) throws JSONException, MessagingException, KnownError{
//    	for(int i=0; i<jo.length(); i++){
//    		JSONObject joo=jo.getJSONObject(i);
//    		MimeBodyPart mbp=new MimeBodyPart(attachAdder,joo);
//    		addBodyPart(mbp);
//    	}
//    }

//	public JSONArray getJson(AttachDeal attachAdder) throws MessagingException, JSONException, KnownError, IOException {
//		JSONArray ret=new JSONArray();
//		if(parts!=null || parts.size()>0){
//			for (int i=0; i< parts.size(); i++) {
//				Part p=(Part) parts.get(i);
//				JSONObject jo=p.getJson(attachAdder);
//				ret.put(jo);
//			}
//		}
//		return ret;
