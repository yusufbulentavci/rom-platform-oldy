...
public class URLName {
	...
	com.bilgidoku.rom.gunluk.Sistem.outln("Test URL: " + url.toString());
	if (argv.length == 0) {
		...
		com.bilgidoku.rom.gunluk.Sistem.outln("URL1 hash code: " + u1.hashCode());
		com.bilgidoku.rom.gunluk.Sistem.outln("URL2 hash code: " + u2.hashCode());
		if (u1.equals(u2))
		    com.bilgidoku.rom.gunluk.Sistem.outln("success, equal");
		else
		    com.bilgidoku.rom.gunluk.Sistem.outln("fail, not equal");
		if (u2.equals(u1))
		    com.bilgidoku.rom.gunluk.Sistem.outln("success, equal");
		else
		    com.bilgidoku.rom.gunluk.Sistem.outln("fail, not equal");
		if (u1.hashCode() == u2.hashCode())
		    com.bilgidoku.rom.gunluk.Sistem.outln("success, hashCodes equal");
		else
		    com.bilgidoku.rom.gunluk.Sistem.outln("fail, hashCodes not equal");
	    }
	}
    }
	...
	com.bilgidoku.rom.gunluk.Sistem.outln("Original URL: " + name);
	com.bilgidoku.rom.gunluk.Sistem.outln("The fullUrl : " + url.toString());
	if (!name.equals(url.toString()))
	    com.bilgidoku.rom.gunluk.Sistem.outln("            : NOT EQUAL!");
	com.bilgidoku.rom.gunluk.Sistem.outln("The protocol is: " + url.getProtocol());
	com.bilgidoku.rom.gunluk.Sistem.outln("The host is: " + url.getHost());
	com.bilgidoku.rom.gunluk.Sistem.outln("The port is: " + url.getPort());
	com.bilgidoku.rom.gunluk.Sistem.outln("The user is: " + url.getUsername());
	com.bilgidoku.rom.gunluk.Sistem.outln("The password is: " + url.getPassword());
	com.bilgidoku.rom.gunluk.Sistem.outln("The file is: " + url.getFile());
	com.bilgidoku.rom.gunluk.Sistem.outln("The ref is: " + url.getRef());
    }
    */
}
