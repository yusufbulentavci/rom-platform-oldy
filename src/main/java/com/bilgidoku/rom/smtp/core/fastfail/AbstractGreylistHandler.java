...
public abstract class AbstractGreylistHandler implements RcptHook {
	...
	private static final HookResult TO_FAST = new HookResult(HookReturnCode.DENYSOFT, SMTPRetCode.LOCAL_ERROR,
	...
	private static final HookResult TEMPORARY_REJECT = new HookResult(HookReturnCode.DENYSOFT, SMTPRetCode.LOCAL_ERROR,
			DSNStatus.getStatus(DSNStatus.TRANSIENT, DSNStatus.NETWORK_DIR_SERVER)
	...
	private HookResult doGreyListCheck(SMTPSession session, SmtpMailAddress senderAddress, SmtpMailAddress recipAddress) {
		String recip = "";
		String sender = "";
	 ...
	 * @throws Exception
	 */
	protected abstract void updateTriplet(String ipAddress, String sender, String recip, int count, long time)
			throws Exception;
