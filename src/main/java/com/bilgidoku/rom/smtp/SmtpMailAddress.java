...
public class SmtpMailAddress {
    ...
    private static final SmtpMailAddress NULL_SENDER = new SmtpMailAddress() {
    ...
    public static SmtpMailAddress nullSender() {
        return NULL_SENDER;
    }
     ...
     */
    public SmtpMailAddress(String address) throws MailAddressException {
     ...
     */
    public SmtpMailAddress(String localPart, String domain) throws MailAddressException {
    ...
    public boolean equals(Object obj) {
        ...
        } else if (obj instanceof SmtpMailAddress) {
            SmtpMailAddress addr = (SmtpMailAddress)obj;
    ...
    /**
     * Return <code>true</code> if the {@link SmtpMailAddress} should represent a null sender (<>)
     * 
     * @return nullsender
     */
    public boolean isNullSender() {
