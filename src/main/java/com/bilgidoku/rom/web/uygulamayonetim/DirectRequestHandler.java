...
public class DirectRequestHandler extends ChannelInboundHandlerAdapter implements CommonRequestHandler, ConnectionSession {
...
//		if (cookieStr != null) {
//			Set<Cookie> cs = CookieDecoder.decode(cookieStr);
//			if (cs != null && cs.size() > 0) {
//				for (Cookie c : cs) {
//					if (c.getName().equals(SECRETNAME) && c.getValue().equals(SECRET)) {
//						auth = true;
//					}
//				}
//			}
